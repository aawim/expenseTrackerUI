    ...
    <form @submit.prevent="save" class="space-y-4">
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-3">
          <label v-for="perm in permissions" :key="perm.id" class="flex items-center space-x-2">
            <input type="checkbox" :value="perm.id" v-model="form.permissions" class="text-blue-600 rounded" />
